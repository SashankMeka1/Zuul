...
void Room::printItem(){//prints items in room and picks up
	...
	cout << "Type in the items you would like to pickup with commas separating(e.g. shirt,shovel,shoe). If you would not like pick anyhting up then just hit enter."<<endl;
